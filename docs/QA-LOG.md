...
| 40 | Click onglet "Projets" dans /projets freeze 30s+ | majeur | ✅ FIXED 53e3f520 (bénéfice transverse du fix #39, FormSection partagée — mesure : click 2.3ms, 0 long task) |
...
2. ~~**Bug #40** : Click tab Projets freeze~~ ✅ **FIXED** (bénéfice transverse du fix #39 sur FormSection — revalidé empiriquement : click tab Projets = 2.3ms sync, 0 long task, page réactive)

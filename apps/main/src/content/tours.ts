...
export const GUIDED_TOURS: GuidedTour[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { target: 'main-content', title: 'Ressources et temps', content: 'Les membres et équipes expliquent qui porte le projet. La feuille de temps mesure le réalisé ; la matrice d’affectation compare la charge planifiée au réalisé.' },
      { target: 'main-content', title: 'Révisions et simulations', content: 'Une révision planning restaure un snapshot contrôlé. Une simulation prépare un scénario sans remplacer le planning officiel tant qu’elle n’est pas appliquée.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { target: 'main-content', title: 'Logos et pays', content: 'Les logos peuvent venir d’une URL ou d’une pièce jointe image. Les listes privilégient un rendu compact : logo discret et drapeau pays.' },

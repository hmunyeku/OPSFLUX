...
export function useConformiteDictionaryState() {
  ...
  const defaultRuleTargetOptions = useMemo(() => ([
    ...
    { value: 'tier_tag', label: t('conformite.rules.targets.tier_tag') },
    { value: 'person_tag', label: t('conformite.rules.targets.person_tag') },
  ...
  const ruleTargetLabels = useDictionaryLabels('compliance_rule_target', {
    ...
    tier_tag: t('conformite.rules.targets.tier_tag'),
    person_tag: t('conformite.rules.targets.person_tag'),

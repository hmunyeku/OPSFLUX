...
import type { GanttActivity, CapacityHeatmapDay } from '@/types/api'
import type { HierarchyFieldNode } from '@/types/assetRegistry'
import { cn } from '@/lib/utils'
import {
  TYPE_COLORS, TYPE_LABELS_FR, DEFAULT_HEATMAP_CONFIG, MS_PER_DAY,
  fmtDate, fmtPax, colorForSaturation, computeActivityProgress,
  utcDateKey, parseISODateUTC, buildBarCellLabels, sumActivityPaxForCell,
} from './ganttHelpers'
import {

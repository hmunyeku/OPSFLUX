...
from app.api.routes.core.verification_scenarios import router as verification_scenarios_router
...
from app.api.routes.modules.teams import router as teams_router
...
from app.api.routes.core.maintenance import router as maintenance_router
...
async def lifespan(app: FastAPI):
    ...
    from app.services.agent.scheduler import (
        ...
        weekly_digest_loop, orphan_rescue_loop,
    )
    ...
    app.state.agent_orphan_task = _asyncio.create_task(orphan_rescue_loop())
...
app.include_router(verification_scenarios_router)

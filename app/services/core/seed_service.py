        ...
        # TravelWiz module dashboard
        {
            ...
            "widgets": [
                ...
                _make_widget("pickup_progress", "Ramassage",
                             {"source": "travelwiz"},
                             {"x": 3, "y": 0, "w": 3, "h": 3}),
                _make_widget("weather_sites", "Météo sites",
                             {"source": "travelwiz"},
                             {"x": 6, "y": 0, "w": 3, "h": 3}),
                _make_widget("alerts_urgent", "Alertes",
                             {"source": "core"},
        ...
        # Asset Registry module dashboard
        {
            ...
            "widgets": [
                _make_widget("assets_overview", "Vue d'ensemble",
                             ...
                             {"x": 0, "y": 0, "w": 3, "h": 4}),
                _make_widget("assets_equipment_by_class", "Équipements par classe",
                             {"source": "asset_registry", "chart_type": "pie"},
                             {"x": 3, "y": 0, "w": 5, "h": 4}),
                _make_widget("assets_by_status", "Équipements par statut",
        ...
        # Support module dashboard — BI professional layout
        {
            ...
            "widgets": [
                ...
                _make_widget("support_by_priority", "Par priorité",
                             ...
                             {"x": 9, "y": 0, "w": 3, "h": 4}),
                _make_widget("support_trend", "Tendance ouverture/résolution",
        ...
        # Papyrus module dashboard
        {
            ...
            "widgets": [
                ...
                _make_widget("papyrus_by_type", "Par type",
                             ...
                             {"x": 9, "y": 0, "w": 3, "h": 4}),
                _make_widget("papyrus_recent_documents", "Documents récents",
                             {"source": "papyrus"},
                             {"x": 0, "y": 4, "w": 12, "h": 5}),
            ],
        },
...
async def seed_dictionary_entries(db: AsyncSession) -> None:
    ...
    translated_entries = [
        ...
        ("compliance_rule_target", "tier", "Entreprise(s)", 3, {"en": "Company / companies"}),
        ("compliance_rule_target", "tier_country", "Pays entreprise", 4, {"en": "Company country"}),
        ("compliance_rule_target", "tier_industry", "Secteur entreprise", 5, {"en": "Company industry"}),
        ("compliance_rule_target", "tier_tag", "Tag entreprise", 6, {"en": "Company tag"}),
        ("compliance_rule_target", "person_tag", "Tag personne", 7, {"en": "Person tag"}),
        ("compliance_rule_target", "asset", "Asset", 8, {"en": "Asset"}),
        ("compliance_rule_target", "department", "Département", 9, {"en": "Department"}),
        ("compliance_rule_target", "job_position", "Fiche de poste", 10, {"en": "Job position"}),
        ("compliance_rule_target", "packlog_cargo", "Colis PackLog", 11, {"en": "PackLog cargo"}),
        ...
        ("project_change_type", "scope", "Perimetre", 1, {"en": "Scope"}),
        ("project_change_type", "planning", "Planning", 2, {"en": "Planning"}),
        ("project_change_type", "budget", "Budget", 3, {"en": "Budget"}),
        ("project_change_type", "technical_decision", "Decision technique", 4, {"en": "Technical decision"}),
        ("project_change_type", "client_input", "Input client", 5, {"en": "Client input"}),
        ("project_change_type", "hse_constraint", "Contrainte HSE", 6, {"en": "HSE constraint"}),
        ("project_change_type", "supplier_delay", "Retard fournisseur", 7, {"en": "Supplier delay"}),
        ("project_change_type", "other", "Autre", 99, {"en": "Other"}),
        ("project_change_status", "draft", "Brouillon", 1, {"en": "Draft"}),
        ("project_change_status", "submitted", "Soumis", 2, {"en": "Submitted"}),
        ("project_change_status", "approved", "Approuve", 3, {"en": "Approved"}),
        ("project_change_status", "rejected", "Rejete", 4, {"en": "Rejected"}),
        ("project_change_status", "implemented", "Implemente", 5, {"en": "Implemented"}),
        ("project_change_status", "cancelled", "Annule", 6, {"en": "Cancelled"}),
        ("project_attachment_type", "decision", "Decision", 1, {"en": "Decision"}),
        ("project_attachment_type", "request", "Demande", 2, {"en": "Request"}),
        ("project_attachment_type", "quote", "Devis", 3, {"en": "Quote"}),
        ("project_attachment_type", "revised_schedule", "Planning revise", 4, {"en": "Revised schedule"}),
        ("project_attachment_type", "meeting_minutes", "Compte rendu", 5, {"en": "Meeting minutes"}),
        ...
        ("project_deliverable_type", "procedure", "Procedure", 3, {"en": "Procedure"}),
        ("project_deliverable_type", "calculation_note", "Note de calcul", 4, {"en": "Calculation note"}),
        ("project_deliverable_type", "acceptance_record", "PV de reception", 5, {"en": "Acceptance record"}),
        ("project_deliverable_type", "validation_file", "Dossier de validation", 6, {"en": "Validation file"}),
        ("project_deliverable_type", "closeout_dossier", "Dossier de cloture", 7, {"en": "Closeout dossier"}),
        ("project_deliverable_type", "other", "Autre", 99, {"en": "Other"}),
        ("project_wbs_type", "phase", "Phase", 1, {"en": "Phase"}),
        ("project_wbs_type", "lot", "Lot", 2, {"en": "Package"}),
        ("project_wbs_type", "discipline", "Discipline", 3, {"en": "Discipline"}),
        ("project_wbs_type", "cost_package", "Lot de cout", 4, {"en": "Cost package"}),
        ("project_wbs_type", "procurement", "Approvisionnement", 5, {"en": "Procurement"}),
        ("project_wbs_type", "construction", "Construction", 6, {"en": "Construction"}),
        ("project_wbs_type", "commissioning", "Mise en service", 7, {"en": "Commissioning"}),
        ("project_wbs_type", "milestone_package", "Lot jalon", 8, {"en": "Milestone package"}),
        ("project_wbs_type", "other", "Autre", 99, {"en": "Other"}),
        ...
        # Sites are tenant-customisable — ops admin can add more via Settings
        ...
        ("moc_status", "cancelled", "Annulé", 4, {"en": "Cancelled"}),
        ("moc_status", "stand_by", "Stand-by", 5, {"en": "Stand-by"}),
        ("moc_status", "approved_to_study", "Confirmé à étudier", 6, {"en": "Approved to study"}),
        ("moc_status", "under_study", "En étude Process", 7, {"en": "Under study"}),
        ("moc_status", "study_in_validation", "Étudié en validation", 8, {"en": "Study in validation"}),
        ("moc_status", "validated", "Validé à exécuter", 9, {"en": "Validated"}),
        ("moc_status", "execution", "Exécution", 10, {"en": "Execution"}),
        ("moc_status", "executed_docs_pending", "Exécuté, PID/ESD à MAJ", 11, {"en": "Executed, docs pending"}),
        ("moc_status", "closed", "Clôturé", 12, {"en": "Closed"}),
        ("moc_priority", "1", "P1 — Haute", 1, {"en": "P1 — High"}),
        ("moc_priority", "2", "P2 — Normale", 2, {"en": "P2 — Normal"}),
        ("moc_priority", "3", "P3 — Faible", 3, {"en": "P3 — Low"}),
        ("moc_modification_type", "permanent", "Permanent", 1, {"en": "Permanent"}),
        ("moc_modification_type", "temporary", "Temporaire", 2, {"en": "Temporary"}),
        ("moc_cost_bucket", "lt_20", "< 20 MXAF", 1, {"en": "< 20 MXAF"}),

...
# ─── Cargo Items ────────────────────────────────────────────────────────────
# CargoRequest, CargoItem, CargoAttachmentEvidence have been EXTRACTED to
# app/models/packlog.py as part of the PackLog ↔ TravelWiz isolation.
# See memory/project_packlog_isolation.md.
#
# The string forward ref `cargo_items: Mapped[list["CargoItem"]]` on
# VoyageManifest above still works because both modules share the same
# SQLAlchemy Base and are both loaded via app/models/__init__.py.
...
# ArticleCatalog, PackageElement, DeckLayout, DeckLayoutItem have been
# EXTRACTED to app/models/packlog.py as part of the PackLog ↔ TravelWiz
# isolation. See memory/project_packlog_isolation.md.

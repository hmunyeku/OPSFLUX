...
async def list_article_catalog(
    ...
    *,
    ...
    from app.services.modules.packlog_service import list_packlog_article_catalog
...
async def get_article_catalog_entry(
    ...
    *,
    ...
    from app.services.modules.packlog_service import get_packlog_article_catalog_entry

    return await get_packlog_article_catalog_entry(db, entity_id=entity_id, article_id=article_id)
...
async def create_article_catalog_entry(
    ...
    *,
    ...
    from app.services.modules.packlog_service import create_packlog_article_catalog_entry
...
async def import_article_catalog_csv(
    ...
    *,
    ...
    from app.services.modules.packlog_service import import_packlog_article_catalog_csv
...
async def match_sap_code(db: AsyncSession, description: str, entity_id: UUID) -> dict:
    from app.services.modules.packlog_service import match_packlog_sap_code

...
// Small presentational helpers + the missingPrereqsFor utility were
// extracted to a sibling file to keep this panel under ~1 700 lines.
// If you need to tweak the stepper, the linked-project card, the
// signature pad wrapper or the FSM precondition checks, go there.
import {
  MOCStepper,
  LinkedProjectCard,
  SignatureSlot,

...
MANIFEST = ModuleManifest(
    ...
    permissions=[
        ...
        "conformite.exemption.read",
        "conformite.exemption.create",
        "conformite.exemption.update",
        "conformite.exemption.approve",
        "conformite.exemption.delete",
        "conformite.audit.read",
        "conformite.audit.create",
        "conformite.audit.update",
        "conformite.audit.submit",
        "conformite.audit.delete",
        "conformite.audit.template.read",
        "conformite.audit.template.create",
        "conformite.audit.template.update",
        "conformite.audit.template.delete",
        "conformite.verify",
        "conformite.import",
        "conformite.export",
    ],
    roles=[
        {
            ...
            "permissions": [
                ...
                "conformite.transfer.read", "conformite.transfer.create",
                "conformite.exemption.read", "conformite.exemption.create", "conformite.exemption.update", "conformite.exemption.approve", "conformite.exemption.delete",
                "conformite.audit.read", "conformite.audit.create", "conformite.audit.update", "conformite.audit.submit", "conformite.audit.delete",
                "conformite.audit.template.read", "conformite.audit.template.create", "conformite.audit.template.update", "conformite.audit.template.delete",
                "conformite.verify",
                "conformite.import", "conformite.export",
            ],
        },
        {
            ...
            "permissions": [
                ...
                "conformite.jobposition.read",
                "conformite.transfer.read",
                "conformite.exemption.read", "conformite.exemption.create",
                "conformite.audit.read", "conformite.audit.create", "conformite.audit.update",
                "conformite.audit.template.read",
            ],
        },
    ],

...
router = APIRouter(prefix="/api/v1/documents", tags=["report_editor"])
...
async def list_documents(
    ...
    from app.services.modules.report_service import list_documents as svc_list
...
async def create_document(
    ...
    from app.schemas.report_editor import DocumentCreate
    from app.services.modules.report_service import create_document as svc_create
...
async def list_templates_early(
    ...
    from app.services.modules.report_service import list_templates as svc_list
...
async def create_template_early(
    ...
    from app.schemas.report_editor import TemplateCreate
    from app.services.modules.report_service import create_template as svc_create
...
async def list_doc_types(
    ...
    from app.services.modules.report_service import list_doc_types as svc_list
...
async def create_doc_type(
    ...
    from app.schemas.report_editor import DocTypeCreate
    from app.services.modules.report_service import create_doc_type as svc_create
...
async def get_document(
    ...
    from app.services.modules.report_service import get_document as svc_get
...
async def update_document(
    ...
    from app.schemas.report_editor import DocumentUpdate
    from app.services.modules.report_service import update_document as svc_update
...
async def save_draft(
    ...
    from app.services.modules.report_service import save_draft as svc_save
...
async def list_revisions(
    ...
    from app.services.modules.report_service import list_revisions as svc_list
...
async def get_revision(
    ...
    from app.services.modules.report_service import get_revision as svc_get
...
async def create_new_revision(
    ...
    from app.services.modules.report_service import create_new_revision as svc_create
    return await svc_create(
        doc_id=doc_id,
        entity_id=entity_id,
        user_id=current_user.id,
...
async def diff_revisions(
    ...
    from app.services.modules.report_service import diff_revisions as svc_diff
...
async def submit_document(
    ...
    from app.services.modules.report_service import submit_document as svc_submit
...
async def approve_document(
    ...
    from app.services.modules.report_service import approve_document as svc_approve
...
async def reject_document(
    ...
    from app.services.modules.report_service import reject_document as svc_reject
...
async def publish_document(
    ...
    from app.services.modules.report_service import publish_document as svc_publish
...
async def update_template(
    ...
    from app.schemas.report_editor import TemplateUpdate
    from app.services.modules.report_service import update_template as svc_update
...
async def list_distribution_lists(
    ...
    from app.services.modules.report_service import list_distribution_lists as svc_list
    return await svc_list(
        entity_id=entity_id,
...
async def create_distribution_list(
    ...
    from app.schemas.report_editor import DistributionListCreate
    from app.services.modules.report_service import create_distribution_list as svc_create
...
async def list_arborescence_nodes(
    ...
    from app.services.modules.report_service import list_arborescence_nodes as svc_list
...
async def create_arborescence_node(
    ...
    from app.schemas.report_editor import ArborescenceNodeCreate
    from app.services.modules.report_service import create_arborescence_node as svc_create
...
async def create_share_link(
    ...
    from app.services.modules.report_service import create_share_link as svc_create
    body = body or {}
    return await svc_create(
...
async def archive_document(
    ...
    from app.services.modules.report_service import archive_document as svc_archive
...
async def delete_document(
    ...
    from app.services.modules.report_service import delete_document as svc_delete

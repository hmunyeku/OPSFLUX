...
# read-only — any cargo write logic lives in packlog_service.
...
# Cargo lifecycle constants (CARGO_FORWARD_TRANSITIONS, CARGO_RETURN_TRANSITIONS)
# moved to app/services/modules/packlog_service.py during PackLog isolation.
...
# update_cargo_status() and suggest_deck_layout() moved to
# app/services/modules/packlog_service.py during PackLog isolation.
# See memory/project_packlog_isolation.md.
...
# _validate_back_cargo_prerequisites(), initiate_back_cargo(), and the
# article catalog wrappers (list_article_catalog, get_article_catalog_entry,
# create_article_catalog_entry, import_article_catalog_csv, match_sap_code)
# moved to app/services/modules/packlog_service.py during PackLog isolation.
# See memory/project_packlog_isolation.md.

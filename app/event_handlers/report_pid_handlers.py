"""Event handlers for Report Editor and PID/PFD modules.
...
# ═══════════════════════════════════════════════════════════════════════════
# Report Editor: document.submitted
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
# Report Editor: document.approved
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
# Report Editor: document.rejected
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
# Report Editor: document.published
# ═══════════════════════════════════════════════════════════════════════════
...
def register_report_pid_handlers(event_bus: EventBus) -> None:
    """Register all Report Editor and PID/PFD event handlers."""
    # Report Editor events
    ...
    logger.info("Report Editor + PID/PFD event handlers registered")

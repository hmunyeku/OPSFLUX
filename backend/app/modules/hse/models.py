...
class Incident(AbstractBaseModel, table=True):
    ...
    witnesses: Optional[str] = Field(default=None)
    injured_persons: Optional[str] = Field(default=None)
    ...
    # Actions correctives
    corrective_actions: Optional[str] = Field(default=None)
    preventive_actions: Optional[str] = Field(default=None)

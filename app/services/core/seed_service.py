...
async def seed_dictionary_entries(db: AsyncSession) -> None:
    ...
    translated_entries = [
        ...
        ("compliance_rule_target", "asset", "Asset", 6, {"en": "Asset"}),
        ("compliance_rule_target", "department", "Département", 7, {"en": "Department"}),
        ("compliance_rule_target", "job_position", "Fiche de poste", 8, {"en": "Job position"}),
        ("compliance_rule_target", "packlog_cargo", "Colis PackLog", 9, {"en": "PackLog cargo"}),

"""Report Editor Pydantic schemas — request/response models.

Covers document types, documents, revisions, templates, template fields,
arborescence nodes, distribution lists, signatures, share links,
workflow actions, and revision diffs.
"""

...
`,
    ...
    classDef done fill:#22c55e,stroke:#4ade80,color:#fff`,
      ...
      {
        title: 'Piloter ressources et temps',
        requiredAnyPermissions: ['project.read', 'project.update'],
        steps: [
          'Ajoutez les membres avec leur role, specialite et taux d\'allocation pour clarifier qui porte le travail.',
          'Attachez les equipes lorsque le projet depend d\'un collectif plutot que d\'une personne unique.',
          'Utilisez la feuille de temps pour saisir le realise semaine par semaine.',
          'Utilisez la matrice d\'affectation pour comparer la charge planifiee et le realise par tache et par membre.',
          'Analysez les pertes separement afin de distinguer derive d\'execution, alea et changement valide.',
        ],
      },
      {
        title: 'Controler documents et preuves',
        requiredAnyPermissions: ['project.read', 'attachment.read'],
        steps: [
          'Verifiez les types de pieces attendues selon le template projet ou le dictionnaire configure.',
          'Ajoutez les pieces dans le gestionnaire polymorphe du bon contexte : projet, tache, changement ou tier.',
          'Associez chaque changement a ses justificatifs avant de demander une validation.',
          'Utilisez la previsualisation lorsque le type de fichier le permet : PDF, image, document Office ou plan technique.',
          'Avant livraison, controlez les preuves obligatoires manquantes et les validations encore en attente.',
        ],
      },
    ],
    tips: [
      ...
      'La feuille de temps mesure le realise ; la matrice d\'affectation explique la charge prevue et les ecarts par membre.',
      'Un changement valide peut augmenter ou reduire le budget et le planning : saisissez toujours le sens de l\'impact.',
    ...
    elementHelp: {
      ...
      'projets.documents.preview': 'Previsualise les pieces jointes quand le format est supporte. Pour les fichiers techniques, conservez le fichier source et son export lisible.',
      ...
      'projets.assignment.matrix': 'Matrice d\'affectation : montre qui est prevu sur quelle tache et compare le planifie au realise.',
  ...
  tiers: {
    ...
    workflows: [
      ...
      {
        title: 'Préparer conformité et documents',
        requiredAnyPermissions: ['tier.read', 'attachment.read'],
        steps: [
          'Ouvrez la fiche entreprise et vérifiez l\'onglet Conformité.',
          'Ajoutez les référentiels obligatoires avec leurs pièces justificatives.',
          'Utilisez les tags de type de pièce jointe plutôt qu\'une saisie libre ambiguë.',
          'Contrôlez la prévisualisation des documents lorsque le fichier est lisible dans OpsFlux.',
          'Avant d\'utiliser le tier dans un projet ou une AdS, vérifiez qu\'il n\'est pas bloqué et que ses preuves sont à jour.',
        ],
      },
    ],
    tips: [
      ...
      'Un logo peut venir d\'une URL ou d\'une pièce jointe image ; l\'affichage doit rester sobre, sans fond forcé.',
      'Les pays s\'affichent en drapeau dans les listes et en drapeau + nom dans la fiche détaillée.',
